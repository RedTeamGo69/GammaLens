...
TICKER_CONFIG: dict[str, dict] = {
    ...
    "QQQ": {
        ...
        "vol_proxy_yf": "^VXN",
        "strike_increment": 1,
        "wing_widths": [3, 5, 7, 10, 15, 20],
        "min_spread_width": {"normal": 5, "event_1": 7, "event_2": 10, "fomc_week": 15},
        "multiplier": 100,
    ...
    "AMZN": {
        ...
        "wing_widths": [2.5, 5, 7.5, 10, 15],
        "min_spread_width": {"normal": 5, "event_1": 7.5, "event_2": 10, "fomc_week": 12.5},
        "multiplier": 100,
        "dividend_yield": 0.0,
        "category": "stock",
        "xsp_scale_to_spx": False,
    ...
    "AMD": {
        ...
        "strike_increment": 1,
        "wing_widths": [2.5, 5, 7.5, 10, 15],
        "min_spread_width": {"normal": 2.5, "event_1": 5, "event_2": 5, "fomc_week": 7.5},
        "multiplier": 100,
        "dividend_yield": 0.0,
        "category": "stock",
        "xsp_scale_to_spx": False,
